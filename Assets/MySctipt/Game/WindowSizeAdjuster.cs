//  WindowSizeAdjuster.cs
//  http://kan-kikuchi.hatenablog.com/entry/WindowSizeAdjuster
//
//  Created by kan.kikuchi on 2023.04.23.

#if UNITY_STANDALONE_WIN || UNITY_STANDALONE_OSX //WindowsかMacでのみ使えるように
using System;
using UnityEngine;
...
public class WindowSizeAdjuster : MonoBehaviour
{
    ...
    //ターゲットのアス比率
    private static readonly float SCREEN_RATE = 9f / 16f;
